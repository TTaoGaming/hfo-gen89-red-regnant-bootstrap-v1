...
export class MediaPipeVisionPlugin implements Plugin {
    ...
    if (stryMutAct_9fa48("663")) {
      ...
      try {
            ...
            if (stryMutAct_9fa48("673")) {
              ...
              try {
                ...
                if (stryMutAct_9fa48("675")) {
                  ...
                  stryCov_9fa48("675");
                  console.warn(stryMutAct_9fa48("676") ? "" : (stryCov_9fa48("676"), '[MediaPipeVisionPlugin] play() failed:'), e);
                }
              }
            }
          };
          if (stryMutAct_9fa48("680") ? v.readyState < 2 : stryMutAct_9fa48("679") ? v.readyState > 2 : stryMutAct_9fa48("678") ? false : stryMutAct_9fa48("677") ? true : (stryCov_9fa48("677", "678", "679", "680"), v.readyState >= 2)) {
            ...
            if (stryMutAct_9fa48("682")) {
              ...
              stryCov_9fa48("682");
              v.addEventListener(stryMutAct_9fa48("683") ? "" : (stryCov_9fa48("683"), 'loadeddata'), startPlaying, stryMutAct_9fa48("684") ? {} : (stryCov_9fa48("684"), {
                once: stryMutAct_9fa48("685") ? false : (stryCov_9fa48("685"), true)
              }));
            }
          }
        }
        ...
        if (stryMutAct_9fa48("686")) {
          ...
          stryCov_9fa48("686");
          console.error(stryMutAct_9fa48("687") ? "" : (stryCov_9fa48("687"), '[MediaPipeVisionPlugin] Camera/MediaPipe init failed:'), err);
        }
      }
    }
  }
  private scheduleFrame(): void {
    if (stryMutAct_9fa48("688")) {
      ...
      stryCov_9fa48("688");
      if (stryMutAct_9fa48("691") ? false : stryMutAct_9fa48("690") ? true : stryMutAct_9fa48("689") ? this.running : (stryCov_9fa48("689", "690", "691"), !this.running)) return;
      this.rafHandle = requestAnimationFrame(stryMutAct_9fa48("692") ? () => undefined : (stryCov_9fa48("692"), () => this.processFrame()));
    }
  }
  private processFrame(): void {
    if (stryMutAct_9fa48("693")) {
      ...
      stryCov_9fa48("693");
      if (stryMutAct_9fa48("696") ? (!this.running || !this.handLandmarker) && !this.videoElement : stryMutAct_9fa48("695") ? false : stryMutAct_9fa48("694") ? true : (stryCov_9fa48("694", "695", "696"), (stryMutAct_9fa48("698") ? !this.running && !this.handLandmarker : stryMutAct_9fa48("697") ? false : (stryCov_9fa48("697", "698"), (stryMutAct_9fa48("699") ? this.running : (stryCov_9fa48("699"), !this.running)) || (stryMutAct_9fa48("700") ? this.handLandmarker : (stryCov_9fa48("700"), !this.handLandmarker)))) || (stryMutAct_9fa48("701") ? this.videoElement : (stryCov_9fa48("701"), !this.videoElement)))) return;
      const now = performance.now();
      const interval = stryMutAct_9fa48("702") ? 1000 * this.config.targetFps : (stryCov_9fa48("702"), 1000 / this.config.targetFps);
      if (stryMutAct_9fa48("705") ? this.videoElement.currentTime !== this.lastVideoTime || now - this.lastProcessTime > interval : stryMutAct_9fa48("704") ? false : stryMutAct_9fa48("703") ? true : (stryCov_9fa48("703", "704", "705"), (stryMutAct_9fa48("707") ? this.videoElement.currentTime === this.lastVideoTime : stryMutAct_9fa48("706") ? true : (stryCov_9fa48("706", "707"), this.videoElement.currentTime !== this.lastVideoTime)) && (stryMutAct_9fa48("710") ? now - this.lastProcessTime <= interval : stryMutAct_9fa48("709") ? now - this.lastProcessTime >= interval : stryMutAct_9fa48("708") ? true : (stryCov_9fa48("708", "709", "710"), (stryMutAct_9fa48("711") ? now + this.lastProcessTime : (stryCov_9fa48("711"), now - this.lastProcessTime)) > interval)))) {
        if (stryMutAct_9fa48("712")) {
          ...
          const handsData: RawHandData[] = (stryMutAct_9fa48("713") ? results.landmarks && [] : (stryCov_9fa48("713"), results.landmarks ?? (stryMutAct_9fa48("714") ? ["Stryker was here"] : (stryCov_9fa48("714"), [])))).map(stryMutAct_9fa48("715") ? () => undefined : (stryCov_9fa48("715"), (landmarks, index) => this.classifyHand(landmarks, index)));
          this.context.eventBus.publish(stryMutAct_9fa48("716") ? "" : (stryCov_9fa48("716"), 'FRAME_PROCESSED'), handsData);
        }
      }
      this.scheduleFrame();
    }
  ...
  private classifyHand(landmarks: any[], index: number): RawHandData {
    if (stryMutAct_9fa48("717")) {
      ...
      // Thumb scores
      const thumbScore = this.clamp01(stryMutAct_9fa48("718") ? (2.0 - this.dist3(landmarks[4], landmarks[9]) / palmWidth) * 1.0 : (stryCov_9fa48("718"), (stryMutAct_9fa48("719") ? 2.0 + this.dist3(landmarks[4], landmarks[9]) / palmWidth : (stryCov_9fa48("719"), 2.0 - (stryMutAct_9fa48("720") ? this.dist3(landmarks[4], landmarks[9]) * palmWidth : (stryCov_9fa48("720"), this.dist3(landmarks[4], landmarks[9]) / palmWidth)))) / 1.0));
      const thumbMiddleScore = this.clamp01(stryMutAct_9fa48("721") ? (1.5 - this.dist3(landmarks[4], landmarks[12]) / palmWidth) * 1.0 : (stryCov_9fa48("721"), (stryMutAct_9fa48("722") ? 1.5 + this.dist3(landmarks[4], landmarks[12]) / palmWidth : (stryCov_9fa48("722"), 1.5 - (stryMutAct_9fa48("723") ? this.dist3(landmarks[4], landmarks[12]) * palmWidth : (stryCov_9fa48("723"), this.dist3(landmarks[4], landmarks[12]) / palmWidth)))) / 1.0));
      const pointerUpScore = stryMutAct_9fa48("724") ? (1 - indexCurl) * 0.4 + middleCurl * 0.1 + ringCurl * 0.1 + pinkyCurl * 0.1 - thumbMiddleScore * 0.3 : (stryCov_9fa48("724"), (stryMutAct_9fa48("725") ? (1 - indexCurl) * 0.4 + middleCurl * 0.1 + ringCurl * 0.1 - pinkyCurl * 0.1 : (stryCov_9fa48("725"), (stryMutAct_9fa48("726") ? (1 - indexCurl) * 0.4 + middleCurl * 0.1 - ringCurl * 0.1 : (stryCov_9fa48("726"), (stryMutAct_9fa48("727") ? (1 - indexCurl) * 0.4 - middleCurl * 0.1 : (stryCov_9fa48("727"), (stryMutAct_9fa48("728") ? (1 - indexCurl) / 0.4 : (stryCov_9fa48("728"), (stryMutAct_9fa48("729") ? 1 + indexCurl : (stryCov_9fa48("729"), 1 - indexCurl)) * 0.4)) + (stryMutAct_9fa48("730") ? middleCurl / 0.1 : (stryCov_9fa48("730"), middleCurl * 0.1)))) + (stryMutAct_9fa48("731") ? ringCurl / 0.1 : (stryCov_9fa48("731"), ringCurl * 0.1)))) + (stryMutAct_9fa48("732") ? pinkyCurl / 0.1 : (stryCov_9fa48("732"), pinkyCurl * 0.1)))) + (stryMutAct_9fa48("733") ? thumbMiddleScore / 0.3 : (stryCov_9fa48("733"), thumbMiddleScore * 0.3)));
      const fistScore = stryMutAct_9fa48("734") ? indexCurl * 0.2 + middleCurl * 0.2 + ringCurl * 0.2 + pinkyCurl * 0.2 - thumbScore * 0.2 : (stryCov_9fa48("734"), (stryMutAct_9fa48("735") ? indexCurl * 0.2 + middleCurl * 0.2 + ringCurl * 0.2 - pinkyCurl * 0.2 : (stryCov_9fa48("735"), (stryMutAct_9fa48("736") ? indexCurl * 0.2 + middleCurl * 0.2 - ringCurl * 0.2 : (stryCov_9fa48("736"), (stryMutAct_9fa48("737") ? indexCurl * 0.2 - middleCurl * 0.2 : (stryCov_9fa48("737"), (stryMutAct_9fa48("738") ? indexCurl / 0.2 : (stryCov_9fa48("738"), indexCurl * 0.2)) + (stryMutAct_9fa48("739") ? middleCurl / 0.2 : (stryCov_9fa48("739"), middleCurl * 0.2)))) + (stryMutAct_9fa48("740") ? ringCurl / 0.2 : (stryCov_9fa48("740"), ringCurl * 0.2)))) + (stryMutAct_9fa48("741") ? pinkyCurl / 0.2 : (stryCov_9fa48("741"), pinkyCurl * 0.2)))) + (stryMutAct_9fa48("742") ? thumbScore / 0.2 : (stryCov_9fa48("742"), thumbScore * 0.2)));
      const palmScore = stryMutAct_9fa48("743") ? (1 - indexCurl) * 0.2 + (1 - middleCurl) * 0.2 + (1 - ringCurl) * 0.2 + (1 - pinkyCurl) * 0.2 - (1 - thumbScore) * 0.2 : (stryCov_9fa48("743"), (stryMutAct_9fa48("744") ? (1 - indexCurl) * 0.2 + (1 - middleCurl) * 0.2 + (1 - ringCurl) * 0.2 - (1 - pinkyCurl) * 0.2 : (stryCov_9fa48("744"), (stryMutAct_9fa48("745") ? (1 - indexCurl) * 0.2 + (1 - middleCurl) * 0.2 - (1 - ringCurl) * 0.2 : (stryCov_9fa48("745"), (stryMutAct_9fa48("746") ? (1 - indexCurl) * 0.2 - (1 - middleCurl) * 0.2 : (stryCov_9fa48("746"), (stryMutAct_9fa48("747") ? (1 - indexCurl) / 0.2 : (stryCov_9fa48("747"), (stryMutAct_9fa48("748") ? 1 + indexCurl : (stryCov_9fa48("748"), 1 - indexCurl)) * 0.2)) + (stryMutAct_9fa48("749") ? (1 - middleCurl) / 0.2 : (stryCov_9fa48("749"), (stryMutAct_9fa48("750") ? 1 + middleCurl : (stryCov_9fa48("750"), 1 - middleCurl)) * 0.2)))) + (stryMutAct_9fa48("751") ? (1 - ringCurl) / 0.2 : (stryCov_9fa48("751"), (stryMutAct_9fa48("752") ? 1 + ringCurl : (stryCov_9fa48("752"), 1 - ringCurl)) * 0.2)))) + (stryMutAct_9fa48("753") ? (1 - pinkyCurl) / 0.2 : (stryCov_9fa48("753"), (stryMutAct_9fa48("754") ? 1 + pinkyCurl : (stryCov_9fa48("754"), 1 - pinkyCurl)) * 0.2)))) + (stryMutAct_9fa48("755") ? (1 - thumbScore) / 0.2 : (stryCov_9fa48("755"), (stryMutAct_9fa48("756") ? 1 + thumbScore : (stryCov_9fa48("756"), 1 - thumbScore)) * 0.2)));

      // Raw winner — NO leaky bucket, NO debounce
      let rawGesture = stryMutAct_9fa48("757") ? "" : (stryCov_9fa48("757"), 'open_palm');
      let maxScore = palmScore;
      if (stryMutAct_9fa48("760") ? pointerUpScore > maxScore || pointerUpScore > 0.6 : stryMutAct_9fa48("759") ? false : stryMutAct_9fa48("758") ? true : (stryCov_9fa48("758", "759", "760"), (stryMutAct_9fa48("763") ? pointerUpScore <= maxScore : stryMutAct_9fa48("762") ? pointerUpScore >= maxScore : stryMutAct_9fa48("761") ? true : (stryCov_9fa48("761", "762", "763"), pointerUpScore > maxScore)) && (stryMutAct_9fa48("766") ? pointerUpScore <= 0.6 : stryMutAct_9fa48("765") ? pointerUpScore >= 0.6 : stryMutAct_9fa48("764") ? true : (stryCov_9fa48("764", "765", "766"), pointerUpScore > 0.6)))) {
        if (stryMutAct_9fa48("767")) {
          {}
        } else {
          stryCov_9fa48("767");
          rawGesture = stryMutAct_9fa48("768") ? "" : (stryCov_9fa48("768"), 'pointer_up');
          maxScore = pointerUpScore;
        }
      }
      if (stryMutAct_9fa48("771") ? fistScore > maxScore || fistScore > 0.6 : stryMutAct_9fa48("770") ? false : stryMutAct_9fa48("769") ? true : (stryCov_9fa48("769", "770", "771"), (stryMutAct_9fa48("774") ? fistScore <= maxScore : stryMutAct_9fa48("773") ? fistScore >= maxScore : stryMutAct_9fa48("772") ? true : (stryCov_9fa48("772", "773", "774"), fistScore > maxScore)) && (stryMutAct_9fa48("777") ? fistScore <= 0.6 : stryMutAct_9fa48("776") ? fistScore >= 0.6 : stryMutAct_9fa48("775") ? true : (stryCov_9fa48("775", "776", "777"), fistScore > 0.6)))) {
        if (stryMutAct_9fa48("778")) {
          {}
        } else {
          stryCov_9fa48("778");
          rawGesture = stryMutAct_9fa48("779") ? "" : (stryCov_9fa48("779"), 'closed_fist');
          maxScore = fistScore;
        }
      }
      ...
      const offset = stryMutAct_9fa48("780") ? (1 - 1 / scale) * 2 : (stryCov_9fa48("780"), (stryMutAct_9fa48("781") ? 1 + 1 / scale : (stryCov_9fa48("781"), 1 - (stryMutAct_9fa48("782") ? 1 * scale : (stryCov_9fa48("782"), 1 / scale)))) / 2);
      const tip = landmarks[8]; // index fingertip
      const mappedX = stryMutAct_9fa48("783") ? (1.0 - tip.x - offset) / scale : (stryCov_9fa48("783"), (stryMutAct_9fa48("784") ? 1.0 - tip.x + offset : (stryCov_9fa48("784"), (stryMutAct_9fa48("785") ? 1.0 + tip.x : (stryCov_9fa48("785"), 1.0 - tip.x)) - offset)) * scale);
      const mappedY = stryMutAct_9fa48("786") ? (tip.y - offset) / scale : (stryCov_9fa48("786"), (stryMutAct_9fa48("787") ? tip.y + offset : (stryCov_9fa48("787"), tip.y - offset)) * scale);
      ...
      const mirroredLandmarks = landmarks.map(stryMutAct_9fa48("788") ? () => undefined : (stryCov_9fa48("788"), (pt: any) => stryMutAct_9fa48("789") ? {} : (stryCov_9fa48("789"), {
        ...pt,
        x: stryMutAct_9fa48("790") ? 1.0 + pt.x : (stryCov_9fa48("790"), 1.0 - pt.x)
      })));
  ...
  private angle3(a: any, b: any, c: any): number {
    if (stryMutAct_9fa48("792")) {
      ...
      stryCov_9fa48("792");
      const ba = stryMutAct_9fa48("793") ? {} : (stryCov_9fa48("793"), {
        x: stryMutAct_9fa48("794") ? a.x + b.x : (stryCov_9fa48("794"), a.x - b.x),
        y: stryMutAct_9fa48("795") ? a.y + b.y : (stryCov_9fa48("795"), a.y - b.y),
        z: stryMutAct_9fa48("796") ? a.z + b.z : (stryCov_9fa48("796"), a.z - b.z)
      });
      const bc = stryMutAct_9fa48("797") ? {} : (stryCov_9fa48("797"), {
        x: stryMutAct_9fa48("798") ? c.x + b.x : (stryCov_9fa48("798"), c.x - b.x),
        y: stryMutAct_9fa48("799") ? c.y + b.y : (stryCov_9fa48("799"), c.y - b.y),
        z: stryMutAct_9fa48("800") ? c.z + b.z : (stryCov_9fa48("800"), c.z - b.z)
      });
      const dot = stryMutAct_9fa48("801") ? ba.x * bc.x + ba.y * bc.y - ba.z * bc.z : (stryCov_9fa48("801"), (stryMutAct_9fa48("802") ? ba.x * bc.x - ba.y * bc.y : (stryCov_9fa48("802"), (stryMutAct_9fa48("803") ? ba.x / bc.x : (stryCov_9fa48("803"), ba.x * bc.x)) + (stryMutAct_9fa48("804") ? ba.y / bc.y : (stryCov_9fa48("804"), ba.y * bc.y)))) + (stryMutAct_9fa48("805") ? ba.z / bc.z : (stryCov_9fa48("805"), ba.z * bc.z)));
      const mag = Math.sqrt(stryMutAct_9fa48("806") ? (ba.x ** 2 + ba.y ** 2 + ba.z ** 2) / (bc.x ** 2 + bc.y ** 2 + bc.z ** 2) : (stryCov_9fa48("806"), (stryMutAct_9fa48("807") ? ba.x ** 2 + ba.y ** 2 - ba.z ** 2 : (stryCov_9fa48("807"), (stryMutAct_9fa48("808") ? ba.x ** 2 - ba.y ** 2 : (stryCov_9fa48("808"), ba.x ** 2 + ba.y ** 2)) + ba.z ** 2)) * (stryMutAct_9fa48("809") ? bc.x ** 2 + bc.y ** 2 - bc.z ** 2 : (stryCov_9fa48("809"), (stryMutAct_9fa48("810") ? bc.x ** 2 - bc.y ** 2 : (stryCov_9fa48("810"), bc.x ** 2 + bc.y ** 2)) + bc.z ** 2))));
      if (stryMutAct_9fa48("813") ? mag !== 0 : stryMutAct_9fa48("812") ? false : stryMutAct_9fa48("811") ? true : (stryCov_9fa48("811", "812", "813"), mag === 0)) return 0;
      return stryMutAct_9fa48("814") ? Math.acos(dot / mag) / (180 / Math.PI) : (stryCov_9fa48("814"), Math.acos(stryMutAct_9fa48("815") ? dot * mag : (stryCov_9fa48("815"), dot / mag)) * (stryMutAct_9fa48("816") ? 180 * Math.PI : (stryCov_9fa48("816"), 180 / Math.PI)));
    }
  }
  private fingerCurlScore(mcp: any, pip: any, dip: any): number {
    if (stryMutAct_9fa48("817")) {
      ...
      stryCov_9fa48("817");
      return this.clamp01(stryMutAct_9fa48("818") ? (180 - this.angle3(mcp, pip, dip)) * 90 : (stryCov_9fa48("818"), (stryMutAct_9fa48("819") ? 180 + this.angle3(mcp, pip, dip) : (stryCov_9fa48("819"), 180 - this.angle3(mcp, pip, dip))) / 90));
    }
  }
  private dist3(a: any, b: any): number {
    if (stryMutAct_9fa48("820")) {
      ...
      stryCov_9fa48("820");
      return Math.sqrt(stryMutAct_9fa48("821") ? (a.x - b.x) ** 2 + (a.y - b.y) ** 2 - (a.z - b.z) ** 2 : (stryCov_9fa48("821"), (stryMutAct_9fa48("822") ? (a.x - b.x) ** 2 - (a.y - b.y) ** 2 : (stryCov_9fa48("822"), (stryMutAct_9fa48("823") ? a.x + b.x : (stryCov_9fa48("823"), a.x - b.x)) ** 2 + (stryMutAct_9fa48("824") ? a.y + b.y : (stryCov_9fa48("824"), a.y - b.y)) ** 2)) + (stryMutAct_9fa48("825") ? a.z + b.z : (stryCov_9fa48("825"), a.z - b.z)) ** 2));
    }
  }
  private clamp01(v: number): number {
    if (stryMutAct_9fa48("826")) {
      ...
      stryCov_9fa48("826");
      return stryMutAct_9fa48("827") ? Math.min(0, Math.min(1, v)) : (stryCov_9fa48("827"), Math.max(0, stryMutAct_9fa48("828") ? Math.max(1, v) : (stryCov_9fa48("828"), Math.min(1, v))));
    }
  }
}