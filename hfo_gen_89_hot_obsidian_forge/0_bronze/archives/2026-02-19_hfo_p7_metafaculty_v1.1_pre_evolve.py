...
CURRENT_SIGNAL_COVERAGE = {
    "Singer (P4)": {"model_name": True, "ai_source": True, "model_tier": False,
                    "model_size_gb": False, "tok_s_actual": False, "inference_ms": False,
                    "temperature": False, "vram_mb": False},
    "Dancer (P5)": {"model_name": True, "ai_source": True, "model_tier": False,
                    "model_size_gb": False, "tok_s_actual": False, "inference_ms": False,
                    "temperature": False, "vram_mb": False},
    "Loop (P4+P5)": {"model_name": True, "ai_source": False, "model_tier": False,
                     "model_size_gb": False, "tok_s_actual": False, "inference_ms": True,
                     "temperature": False, "vram_mb": False},
}
