...
EVENT TYPES:
    hfo.gen89.scheduler.heartbeat       — Scheduler alive pulse
    hfo.gen89.scheduler.watchdog        — Fleet health check
    hfo.gen89.scheduler.cycle_complete  — Full cycle report
    hfo.gen89.scheduler.restart         — Daemon restarted
    hfo.gen89.scheduler.error           — Scheduler error
...
def print_uptime_card():
    ...
    print("=" * 76)
    print("  HFO Gen89 — STRANGE LOOP PLATFORM UPTIME REPORT CARD")
