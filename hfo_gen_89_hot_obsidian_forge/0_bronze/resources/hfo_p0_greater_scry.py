...
══════════════════════════════════════════════════════════════════════
  ...
  Event Types:
    hfo.gen89.p0.greater_scry.intel      — Web intelligence for a seal/sphere target
    hfo.gen89.p0.greater_scry.heartbeat  — Daemon alive pulse
    hfo.gen89.p0.greater_scry.cycle      — Cycle summary (targets scried, results)
