#!/usr/bin/env python3
"""
hfo_p7_planar_binding.py — P7 Spider Sovereign PLANAR_BINDING Spell (Gen89)
=============================================================================
...
Event Types:
    hfo.gen89.p7.planar_binding.bind       — Daemon bound (circle inscribed)
    hfo.gen89.p7.planar_binding.inspect    — Binding state checked
    hfo.gen89.p7.planar_binding.release    — Binding dissolved
    hfo.gen89.p7.planar_binding.broken     — Binding broken (daemon died)
    hfo.gen89.p7.planar_binding.fleet      — Fleet binding operation
    hfo.gen89.p7.planar_binding.error      — Spell failed
...
def main():
    parser = argparse.ArgumentParser(
        description="P7 Spider Sovereign — PLANAR_BINDING Spell (Gen89)",
