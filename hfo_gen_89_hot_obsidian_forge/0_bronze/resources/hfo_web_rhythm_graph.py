...
SOURCE_PORT = {
    "hfo_singer_ai_gen89":            "P4",
    "hfo_p5_daemon_gen89_v1.0":       "P5",
    "hfo_p6_kraken_swarm_gen89":      "P6",
    "hfo_p7_spell_gate_gen89":        "P7",
    "hfo_p7_foresight_daemon_gen89":  "P7",
    "hfo_meadows_engine_gen89":       "P7",  # L4-L6 lives under P7 NAVIGATE
    "hfo_spider_tremorsense_gen89":   "P7",
    "hfo_p7_foresight_gen89":         "P7",
}
...
def analyze_rhythm(hours_back: float = 2.0):
    ...
    singer_hb = heartbeats.get("hfo_singer_ai_gen89", [])
    if len(singer_hb) >= 3:
    ...
    kraken_hb = heartbeats.get("hfo_p6_kraken_swarm_gen89", [])
    if len(kraken_hb) >= 3:
