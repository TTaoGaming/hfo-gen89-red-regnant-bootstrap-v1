#!/usr/bin/env python3
"""
hfo_p7_spell_gate.py — P7 Spider Sovereign Spell Gate (Gen89)
================================================================
...
Event Types:
  hfo.gen89.p7.spell_gate.summon     — Daemon summoned (pre-flight passed)
  hfo.gen89.p7.spell_gate.incarnate  — Daemon confirmed alive
  hfo.gen89.p7.spell_gate.banish     — Daemon stopped
  hfo.gen89.p7.spell_gate.scrying    — Status check performed
  hfo.gen89.p7.spell_gate.error      — Spell failed
  hfo.gen89.p7.spell_gate.heartbeat  — Watchdog pulse
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="P7 Spider Sovereign — Spell Gate (Gen89)",
