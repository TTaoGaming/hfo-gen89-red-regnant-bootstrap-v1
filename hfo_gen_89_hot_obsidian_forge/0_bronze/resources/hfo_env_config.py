...
==========================================================
v1.0 | Gen89 | Port: P7 NAVIGATE (governance) | Medallion: bronze
...
class IdentityConfig:
    ...
    forge_dir: str = _env("HFO_FORGE", "hfo_gen_89_hot_obsidian_forge")
...
BRONZE_RESOURCES = FORGE_PATH / "0_bronze" / "resources"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="HFO Gen89 Environment Config")
    ...
    print("═══ HFO Gen89 Environment Configuration ═══")
