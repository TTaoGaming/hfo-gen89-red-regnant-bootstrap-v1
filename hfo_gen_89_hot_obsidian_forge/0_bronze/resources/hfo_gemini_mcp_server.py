#!/usr/bin/env python3
"""
hfo_gemini_mcp_server.py — HFO Gen89 Google Gemini MCP Server
==============================================================
...
mcp = FastMCP("HFO Gemini Gen89 — Google AI Bridge")

# Startup diagnostics
print(f"[HFO Gemini MCP] Gen89 | Root: {HFO_ROOT}", file=sys.stderr)
