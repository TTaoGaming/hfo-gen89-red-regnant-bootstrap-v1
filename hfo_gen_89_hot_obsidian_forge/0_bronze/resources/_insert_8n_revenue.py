...
FORGE = "hfo_gen_89_hot_obsidian_forge"
DB = os.path.join(FORGE, "2_gold", "resources", "hfo_gen89_ssot.sqlite")
...
metadata = {
    ...
    "cross_references": [
        "Doc 7855: braided_mission_thread_alpha_omega_hfo_gen88v8",
...
""", (
    "diataxis",
    "hfo_gen_89_hot_obsidian_forge/0_bronze/resources/2026-02-19_REFERENCE_8N_OCTREE_REVENUE_ARCHITECTURE_V1.md",
    content,
    content_hash,
