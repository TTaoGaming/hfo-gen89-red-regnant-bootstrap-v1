...
Stigmergy Events:
    hfo.gen89.p5.flame_strike.purge     — Successful purge with provenance
    hfo.gen89.p5.flame_strike.blocked   — Purge blocked by safety gate
    hfo.gen89.p5.flame_strike.dry_run   — Dry run preview
...
EVENT_PREFIX = "hfo.gen89.p5.flame_strike"
VERSION = "1.0.0"
