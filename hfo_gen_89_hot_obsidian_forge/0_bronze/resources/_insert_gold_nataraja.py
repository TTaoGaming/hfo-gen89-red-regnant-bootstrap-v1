...
db_path = 'hfo_gen_89_hot_obsidian_forge/2_gold/resources/hfo_gen89_ssot.sqlite'
doc_path = 'hfo_gen_89_hot_obsidian_forge/2_gold/resources/EXPLANATION_NATARAJA_WAIL_OF_THE_BANSHEE_GEN89_PHOENIX_PROTOCOL_V1.md'
...
metadata = {
    ...
    'title': 'The Nataraja Dance - WAIL_OF_THE_BANSHEE and the Gen89 Phoenix Protocol',
...
tags = ','.join(['gold', 'forge:hot', 'diataxis:explanation', 'nataraja',
                 'wail-of-the-banshee', 'phoenix-protocol', 'gen89', 'p4', 'p5',
...
bluf = ('The Nataraja Dance - WAIL_OF_THE_BANSHEE and the Gen89 Phoenix Protocol. '
        'Gold diataxis explanation of Gen89 extinction as NATARAJA architecture. '
...
''', (
    ...
    word_count,
    content_hash,
    'hfo_gen_89_hot_obsidian_forge/2_gold/resources/EXPLANATION_NATARAJA_WAIL_OF_THE_BANSHEE_GEN89_PHOENIX_PROTOCOL_V1.md',
    content,
    json.dumps(metadata),
    now,
    '2026-02-19'
