#!/usr/bin/env python3
"""
hfo_prey8_loop.py — PREY8 Strange Loop v1.0 (Gen89)
====================================================
...
Event Cadence (per cycle, ~7 events written):
  hfo.gen89.singer.strife     — P4 antipattern signal
  hfo.gen89.singer.splendor   — P4 positive pattern signal
  hfo.gen89.singer.heartbeat  — P4 alive pulse
  hfo.gen89.dancer.death      — P5 destroy/purge recommendation
  hfo.gen89.dancer.dawn       — P5 protect/resurrect recommendation
  hfo.gen89.dancer.heartbeat  — P5 alive pulse
  hfo.gen89.prey8_loop.pulse  — Combined loop pulse (Singer + Dancer summary)
