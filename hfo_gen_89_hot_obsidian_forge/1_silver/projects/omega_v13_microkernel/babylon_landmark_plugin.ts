...
export class BabylonLandmarkPlugin implements Plugin {
    ...
    private frameHandler?: (hands: HandFrame[]) => void;
    ...
    async start(): Promise<void> {
        this.frameHandler = (hands: HandFrame[]) => this.onFrame(hands);
        globalEventBus.subscribe('FRAME_PROCESSED', this.frameHandler);
        console.log('[BabylonLandmarkPlugin] Subscribed to FRAME_PROCESSED.');
    }

    async stop(): Promise<void> {
        if (this.frameHandler) {
            globalEventBus.unsubscribe('FRAME_PROCESSED', this.frameHandler);
        }
        this.hideAll();
    }
    ...
    private onFrame(hands: HandFrame[]): void {
