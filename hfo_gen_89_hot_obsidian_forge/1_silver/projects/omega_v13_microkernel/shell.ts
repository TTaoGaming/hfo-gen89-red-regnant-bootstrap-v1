...
export class Shell {
    ...
    mount(): void {
        ...
        this.eventBus.subscribe('STATE_CHANGE', this.onStateChange.bind(this));
        this.eventBus.subscribe('FRAME_PROCESSED', this.onFrameProcessed.bind(this));
        this.eventBus.subscribe('SETTINGS_TOGGLE', this.toggleSettings.bind(this));
