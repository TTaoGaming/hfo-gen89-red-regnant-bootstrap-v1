#!/usr/bin/env python3
"""
hfo_p7_wish.py — P7 Spider Sovereign WISH Spell (Gen90)
=========================================================
...
Event Types:
    hfo.gen90.p7.wish.cast         — Wish declared + evaluated
    hfo.gen90.p7.wish.granted      — Wish condition satisfied
    hfo.gen90.p7.wish.denied       — Wish condition violated
    hfo.gen90.p7.wish.audit        — Batch re-evaluation
    hfo.gen90.p7.wish.revoke       — Wish deactivated
    hfo.gen90.p7.wish.error        — Spell failed
...
def _check_medallion_boundary() -> tuple[bool, list[str]]:
    ...
    gold_dir = FORGE_ROOT / "2_gold" / "2_resources"
    silver_dir = FORGE_ROOT / "1_silver" / "2_resources"
    ...
    if gold_dir.exists():
        expected_gold = {"hfo_gen90_ssot.sqlite"}
...
def main():
    parser = argparse.ArgumentParser(
        description="P7 Spider Sovereign — WISH Spell (Gen90)",
