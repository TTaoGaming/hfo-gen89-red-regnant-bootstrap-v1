...
DAEMON_VERSION = "1.0"
DAEMON_PORT = "P7"
SOURCE_TAG = f"hfo_metafaculty_gen90_v{DAEMON_VERSION}"

# Event types — the METAFACULTY's voice
EVT_SCAN       = "hfo.gen90.metafaculty.scan"
EVT_PARETO     = "hfo.gen90.metafaculty.pareto"
EVT_STEERING   = "hfo.gen90.metafaculty.steering"
EVT_ARCHIVE    = "hfo.gen90.metafaculty.archive"
EVT_PHEROMONE  = "hfo.gen90.metafaculty.pheromone"
EVT_VIBRATION  = "hfo.gen90.metafaculty.vibration"
EVT_HEARTBEAT  = "hfo.gen90.metafaculty.heartbeat"
EVT_ERROR      = "hfo.gen90.metafaculty.error"
...
def resolve_ssot_path() -> str:
    ...
    for candidate in [
        _HERE.parent.parent / "2_gold" / "2_resources" / "hfo_gen90_ssot.sqlite",
    ]:
        if candidate.exists():
