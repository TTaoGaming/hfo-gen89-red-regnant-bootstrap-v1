#!/usr/bin/env python3
"""
hfo_stigmergy_weekly_report.py — HFO Gen90 Weekly Stigmergy Rollup
==================================================================
...
"""
    ...
    report_path = HFO_ROOT / "hfo_gen_90_hot_obsidian_forge" / "0_bronze" / "archives" / f"{now.strftime('%Y-%m-%d')}_stigmergy_weekly_rollup.md"
