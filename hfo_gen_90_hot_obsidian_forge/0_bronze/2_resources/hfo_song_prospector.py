#!/usr/bin/env python3
"""
hfo_song_prospector.py — SONG PROSPECTOR Daemon (Gen90)
========================================================
v1.0 | Gen90 | Port: P4 DISRUPT | Commander: Red Regnant
...
STIGMERGY EVENT TYPES (port-sharded to P4):
    hfo.gen90.p4.song_prospector.proposal    — A new song proposal
    hfo.gen90.p4.song_prospector.heartbeat   — Daemon alive signal
    hfo.gen90.p4.song_prospector.error       — Daemon self-reported error
    hfo.gen90.p4.song_prospector.start       — Daemon started
    hfo.gen90.p4.song_prospector.stop        — Daemon stopped
...
REVIEW PROPOSALS:
    ...
    WHERE event_type = 'hfo.gen90.p4.song_prospector.proposal'
...
P4_EVENT_PREFIX = "hfo.gen90.p4.song_prospector"
...
def main():
    parser = argparse.ArgumentParser(
        description="SONG PROSPECTOR — Listener in the Deep Library (Gen90 P4)",
