...
The Phoenix Protocol overlay (from Gen90 Nataraja doc):
...
DEFAULT_CONTINGENCIES: list[ContingencyTrigger] = [
    ...
    ContingencyTrigger(
        ...
        detect="hfo.gen90.prey8.perceive",
    ...
    ContingencyTrigger(
        ...
        detect="hfo.gen90.daemon.model_pull",
    ...
    ContingencyTrigger(
        ...
        detect="hfo.gen90.daemon.swarm_stop",
...
class ContingencyWatcher:
    ...
    def watch(self):
        ...
        _write_stigmergy(
            "hfo.gen90.p5.contingency_activated",
            {
    ...
    def _fire_trigger(self, trigger: ContingencyTrigger, event: dict):
        ...
        if trigger.strategy == "restart_daemon":
            ...
            _write_stigmergy(
                "hfo.gen90.p5.contingency_alert",
                {
            ...
            _write_stigmergy(
                "hfo.gen90.p5.contingency_chimera_rescue",
        ...
        _write_stigmergy(
            "hfo.gen90.p5.contingency_fired",
            {
