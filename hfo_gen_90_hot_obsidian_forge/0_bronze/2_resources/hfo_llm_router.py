#!/usr/bin/env python3
"""
hfo_llm_router.py — HFO Gen90 Vendor-Agnostic LLM Router
==========================================================
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        if live_ram >= RAM_BLOCK_THRESHOLD_PCT:
            self._write_stigmergy("hfo.gen90.llm_router.ram_blocked", {
                "role": role,
                "ram_pct": live_ram,
            })
        ...
        for provider in chain:
            ...
            try:
                ...
                self._write_stigmergy("hfo.gen90.llm_router.inference", {
        ...
        self._write_stigmergy("hfo.gen90.llm_router.exhausted", {
            "role": role,
