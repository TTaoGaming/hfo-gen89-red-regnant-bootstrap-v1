...
Resource Signals (stigmergy-based):
    hfo.gen90.resource.request  — Another agent wants GPU/CPU
    hfo.gen90.resource.yield    — Kraken yields resources
    hfo.gen90.resource.resume   — Resources freed, resume work
    hfo.gen90.resource.snapshot — Periodic resource state dump
...
class SwarmOrchestrator:
    ...
    async def check_stigmergy_yields(self):
        ...
        Other agents can write hfo.gen90.resource.request events.
        ...
        try:
            ...
            rows = conn.execute(
                """SELECT id, data_json, timestamp FROM stigmergy_events
                   WHERE event_type = 'hfo.gen90.resource.request'
    ...
    def _log_resource_event(self, event_type: str, subject: str, data: dict):
        ...
        try:
            ...
            event = {
                "specversion": "1.0",
                "type": event_type,
                "source": "hfo_p6_kraken_swarm_gen90",
                "subject": subject,
                "time": now,
                "data": data,
            }
            ...
            conn.execute(
                """INSERT OR IGNORE INTO stigmergy_events
                   ...
                   VALUES (?, ?, ?, ?, ?, ?)""",
                (event_type, now, subject, "hfo_p6_kraken_swarm_gen90",
