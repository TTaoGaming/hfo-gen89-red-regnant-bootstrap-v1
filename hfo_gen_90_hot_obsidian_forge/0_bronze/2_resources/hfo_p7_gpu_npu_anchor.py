...
========================================================
v1.0 | Gen90 | Port: P7 NAVIGATE | Layer: Diagnostics
...
EVENT TYPES:
    hfo.gen90.p7.gpu_npu_anchor.diagnose   — Full diagnostic report
    hfo.gen90.p7.gpu_npu_anchor.benchmark  — Inference benchmark results
    hfo.gen90.p7.gpu_npu_anchor.preload    — Model preload event
    hfo.gen90.p7.gpu_npu_anchor.unload     — VRAM release event
...
def main():
    parser = argparse.ArgumentParser(
        description="P7 GPU/NPU Utilization Anchor (Gen90)",
