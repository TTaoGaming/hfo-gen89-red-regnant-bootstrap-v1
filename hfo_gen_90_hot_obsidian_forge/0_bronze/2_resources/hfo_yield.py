...
Writes a hfo.gen90.prey8.yield CloudEvent to stigmergy_events.
...
def yield_event(
    ...
    event_data = {
        ...
        "signal_metadata": {"source": "hfo_yield.py_gen90_v1"},
    }

    event = make_cloudevent(
        event_type="hfo.gen90.prey8.yield",
        subject="prey-yield",
        data=event_data,
        source="hfo_yield.py_gen90_v1",
    )
    ...
    try:
        ...
        receipt["yield_event_note"] = f"IntegrityError: {e}"
