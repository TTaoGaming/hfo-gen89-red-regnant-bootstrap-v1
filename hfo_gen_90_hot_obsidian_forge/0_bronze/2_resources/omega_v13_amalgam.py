...
Usage:
    python hfo_gen_90_hot_obsidian_forge/0_bronze/resources/omega_v13_amalgam.py
...
PROJECT_ROOT = pathlib.Path(
    r"C:\hfoDev\hfo_gen_90_hot_obsidian_forge\1_silver\projects\omega_v13_microkernel"
)
