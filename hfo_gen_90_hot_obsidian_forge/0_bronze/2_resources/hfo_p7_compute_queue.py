...
==========================================================
v1.0 | Gen90 | Port: P7 NAVIGATE | Layer: Infrastructure
...
EVENT TYPES:
    hfo.gen90.p7.compute_queue.started    — Queue daemon started
    hfo.gen90.p7.compute_queue.completed  — Work item completed
    hfo.gen90.p7.compute_queue.drained    — Queue fully drained
    hfo.gen90.p7.compute_queue.error      — Work item failed
    hfo.gen90.p7.compute_queue.stats      — Periodic stats snapshot
...
def main():
    parser = argparse.ArgumentParser(
        description="P7 GPU/NPU Compute Queue (Gen90)",
