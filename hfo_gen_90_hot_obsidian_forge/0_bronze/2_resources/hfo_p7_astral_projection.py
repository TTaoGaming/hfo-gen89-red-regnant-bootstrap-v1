#!/usr/bin/env python3
"""
hfo_p7_astral_projection.py — P7 Spider Sovereign ASTRAL_PROJECTION Spell (Gen90)
==================================================================================
...
Event Types:
    hfo.gen90.p7.astral_projection.project    — Full topology snapshot
    hfo.gen90.p7.astral_projection.flows      — Stigmergy flow analysis
    hfo.gen90.p7.astral_projection.survey     — Medallion layer survey
    hfo.gen90.p7.astral_projection.taxonomy   — Document type breakdown
    hfo.gen90.p7.astral_projection.timeline   — Temporal analysis
...
def main():
    parser = argparse.ArgumentParser(
        description="P7 Spider Sovereign — ASTRAL_PROJECTION Spell (Gen90)",
