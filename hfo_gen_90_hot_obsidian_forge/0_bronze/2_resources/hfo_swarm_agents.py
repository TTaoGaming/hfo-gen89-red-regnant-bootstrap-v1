...
triage_agent = Agent(
    name="Triage Agent",
    model=DEFAULT_MODEL,
    instructions="""You are the Triage Agent for HFO Gen90. Your job is to understand
...
research_agent = Agent(
    name="Research Agent",
    model=DEFAULT_MODEL,
    instructions="""You are the Research Agent for HFO Gen90. You specialize in:
...
coder_agent = Agent(
    name="Coder Agent",
    model=DEFAULT_MODEL,
    instructions="""You are the Coder Agent for HFO Gen90. You specialize in:
...
analyst_agent = Agent(
    name="Analyst Agent",
    model=DEFAULT_MODEL,
    instructions="""You are the Analyst Agent for HFO Gen90. You specialize in:
...
def interactive_loop():
    ...
    print("=" * 60)
    print("  HFO Gen90 — Ollama Swarm (Interactive)")
