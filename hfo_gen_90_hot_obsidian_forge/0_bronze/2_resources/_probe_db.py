import sqlite3
conn = sqlite3.connect(r'c:\hfoDev\hfo_gen_90_hot_obsidian_forge\2_gold\resources\hfo_gen90_ssot.sqlite')
c = conn.cursor()
...
print("\n=== DB FILE SIZE ===")
import os
sz = os.path.getsize(r'c:\hfoDev\hfo_gen_90_hot_obsidian_forge\2_gold\resources\hfo_gen90_ssot.sqlite')
