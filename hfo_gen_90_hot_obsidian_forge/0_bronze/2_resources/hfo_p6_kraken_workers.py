...
===========================================================
v1.0 | Gen90 | Port: P6 ASSIMILATE | Layer: Workers
        ...
        for row in rows:
            ...
            if not dry_run:
                ...
                write_stigmergy_event(
                    conn, "hfo.gen90.kraken.progressive_summary",
    ...
    try:
        ...
        for row in rows:
            ...
            if not dry_run:
                ...
                write_stigmergy_event(
                    conn, "hfo.gen90.kraken.knowledge_graph",
                    f"KG:doc_{doc_id}",
                    {
                        "doc_id": doc_id,
                        "title": title[:100],
    ...
    try:
        ...
        for row in rows:
            ...
            if not dry_run:
                ...
                write_stigmergy_event(
                    conn, "hfo.gen90.kraken.tags_expanded",
                    f"TAGS:doc_{doc_id}",
                    {
                        "doc_id": doc_id,
                        "title": title[:100],
    ...
    try:
        ...
        if not dry_run and results["issues_found"] > 0:
            try:
                ...
                write_stigmergy_event(
                    wconn, "hfo.gen90.kraken.quality_audit",
