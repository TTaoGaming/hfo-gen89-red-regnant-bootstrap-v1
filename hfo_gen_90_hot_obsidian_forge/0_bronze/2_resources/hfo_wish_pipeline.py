...
Event Types:
  hfo.gen90.wish.anchor      — Baseline captured
  hfo.gen90.wish.intent      — Intent received
  hfo.gen90.wish.fca         — Formal concept analysis complete
  hfo.gen90.wish.sbe         — SBE/ATDD specs generated
  hfo.gen90.wish.candidate   — MAP-ELITE candidate generated
  hfo.gen90.wish.nataraja    — Adversarial test result (death/dawn)
  hfo.gen90.wish.knowledge   — Knowledge extracted
  hfo.gen90.wish.loop        — Strange loop pulse
  hfo.gen90.wish.complete    — WISH pipeline complete
  hfo.gen90.wish.error       — Pipeline error
...
BRONZE_RES = FORGE / "0_bronze" / "2_resources"
SSOT_DB = FORGE / "2_gold" / "2_resources" / "hfo_gen90_ssot.sqlite"
