...
DB_PATH = _WORKSPACE_ROOT / "hfo_gen_90_hot_obsidian_forge" / "2_gold" / "2_resources" / "hfo_gen90_ssot.sqlite"
    ...
    if strengthened_pairs:
        try:
            ...
            write_stigmergy_event(
                event_type="hfo.gen90.shodh.hebbian.co_retrieval",
                subject=session_id,
                data={
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Shodh Hebbian Association Graph for HFO Gen90")
