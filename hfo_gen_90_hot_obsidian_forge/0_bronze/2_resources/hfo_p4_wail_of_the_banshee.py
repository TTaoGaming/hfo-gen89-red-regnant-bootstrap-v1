...
Stigmergy Events:
    hfo.gen90.p4.wail.scream        — Critical alert (CANNOT BE SILENCED)
    hfo.gen90.p4.wail.silence       — All clear (quiet = healthy)
    hfo.gen90.p4.wail.heartbeat     — Daemon heartbeat
...
EVENT_PREFIX = "hfo.gen90.p4.wail"
VERSION = "1.0.0"
