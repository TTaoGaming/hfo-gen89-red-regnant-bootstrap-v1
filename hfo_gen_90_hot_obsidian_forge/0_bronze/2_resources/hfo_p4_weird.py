...
Stigmergy Events:
    hfo.gen90.p4.weird.sweep       — Full sweep results
    hfo.gen90.p4.weird.kill        — Individual mutant kill
    hfo.gen90.p4.weird.survivor    — Surviving mutant (needs human)
    hfo.gen90.p4.weird.heartbeat   — Daemon heartbeat
...
Feature: WEIRD — Mutation Kill Sweep
  ...
  Scenario: Scan discovers hardcoded forge paths
    Given a Python file contains a string literal matching "hfo_gen_90_hot_obsidian_forge"
    When WEIRD sweep scans the file
...
EVENT_PREFIX = "hfo.gen90.p4.weird"
VERSION = "1.0.0"
