...
def _load_pointer_registry() -> dict:
    p = HFO_ROOT / "hfo_gen90_pointers_blessed.json"
    if p.exists():
...
def main():
    ...
    if args.apex:
        ...
        prompt = args.prompt or f"You are the {port} commander of HFO Gen90. Assess the current state of your port's domain and identify the single highest-leverage action to take next."
