#!/usr/bin/env python3
"""
hfo_p5_dancer_daemon.py — Fast AI Dancer v1.0 — P5 Pyre Praetorian (Gen90)
==========================================================
...
Event Types:
  hfo.gen90.dancer.death       — DEATH dance step (purge/ward/defend/kill recommendation)
  hfo.gen90.dancer.dawn        — DAWN dance step (contingency/ward/resurrect/aura recommendation)
  hfo.gen90.dancer.heartbeat   — Dancer alive pulse
  hfo.gen90.dancer.health      — Full health snapshot (every Nth cycle)
  hfo.gen90.dancer.error       — Self-reported error (recursive death)
