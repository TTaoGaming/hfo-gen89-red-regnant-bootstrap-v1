...
CONSUME_EVENTS = [
    "hfo.gen90.p4.singer%",           # Singer strife/splendor
    "hfo.gen90.p5.dancer%",           # Dancer death/dawn
    "hfo.gen90.p7.enrichment%",       # P7 enrichment
    "hfo.gen90.kraken.npu%",          # Kraken NPU discoveries
    "hfo.gen90.kraken.gpu%",          # Kraken GPU enrichments
    "hfo.gen90.p7.summoner%",         # Summoner foresight
    "hfo.gen90.p7.tremorsense%",      # Resource availability
    "hfo.gen90.devourer%",            # Own previous output
]
