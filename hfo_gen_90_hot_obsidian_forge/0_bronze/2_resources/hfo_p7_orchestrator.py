...
================================================================
v2.0 | Gen90 | Port: P7 NAVIGATE | Commander: Spider Sovereign
...
def start_fleet(dry_run: bool = False):
    ...
    if not dry_run:
        _emit_fleet_event("hfo.gen90.p7.fleet.started", {
...
def stop_fleet(dry_run: bool = False):
    ...
    if not dry_run:
        queue.clear()
        _emit_fleet_event("hfo.gen90.p7.fleet.stopped", {
...
#
# Event type:  hfo.gen90.p7.time_stop
# Subject:     P7:NAVIGATE:TIME_STOP
# Data:        Full fleet_state_json() + snapshot metadata
# ═══════════════════════════════════════════════════════════════

_TIME_STOP_EVENT_TYPE = "hfo.gen90.p7.time_stop"
...
def print_time_stop():
    ...
    print()
    print("  [TIME_STOP written to SSOT as hfo.gen90.p7.time_stop]")
    print("=" * 66)
    print()
...
def daemon_loop(interval_seconds: int = 3600):
    ...
    _emit_fleet_event("hfo.gen90.p7.daemon.started", {
        "mode": "TIME_STOP_LOOP",
    ...
    _emit_fleet_event("hfo.gen90.p7.daemon.stopped", {
        "mode": "TIME_STOP_LOOP",
