...
def run_chimera_loop(
    ...
    # Log initialization
    _write_stigmergy("hfo.gen90.chimera.init", {
    ...
    for gen_num in range(generations):
        ...
        for idx, genome in enumerate(population):
            ...
            _write_stigmergy("hfo.gen90.chimera.eval", {
                "generation": gen_num,
                "genome_id": genome.genome_id,
        ...
        _write_stigmergy("hfo.gen90.chimera.generation", {
            "generation": gen_num,
    ...
    # Log final results
    _write_stigmergy("hfo.gen90.chimera.complete", {
...
def main():
    ...
    if result["best_genome"]:
        ...
        prompt_path = HFO_ROOT / "hfo_gen_90_hot_obsidian_forge" / "0_bronze" / "2_resources" / f"chimera_best_{best.genome_id}.txt"
