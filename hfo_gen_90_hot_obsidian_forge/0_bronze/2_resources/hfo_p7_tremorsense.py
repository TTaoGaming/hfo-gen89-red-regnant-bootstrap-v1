#!/usr/bin/env python3
"""
hfo_p7_tremorsense.py — P7 Spider Sovereign TREMORSENSE Spell (Gen90)
======================================================================
...
EVENT TYPES:
    hfo.gen90.p7.tremorsense.audit      — Hourly uptime report
    hfo.gen90.p7.tremorsense.heartbeat  — Daemon alive pulse
    hfo.gen90.p7.tremorsense.alert      — Uptime below threshold
